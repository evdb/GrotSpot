...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{GUARDORSTEAL_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{GUARDORSTEAL_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
grotspot_server.pl - Catalyst Testserver

=head1 SYNOPSIS

grotspot_server.pl [options]
